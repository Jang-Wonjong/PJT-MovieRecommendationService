...
처음 프로젝트를 시작할 땐 '패스만 하자' 라는 생각이었다. 

그런데 프로젝트를 진행하며 처음에 설계했던 대로 하나씩 구현해나가면서 재미를 느꼈고, 

오류 때문에 정말 힘들었지만 그것을 해결했을 때의 성취감이 더욱 커 점점 빠져들게 됐다.

그래서인지 처음 생각과 다르게 욕심이 생겨 더 많은 기능, 더 멋진 디자인을 하고 싶었다.

그 덕에 공식 문서나 구글링, 교재를 찾아보며 서치하는 능력도 길렀고 배웠던 것들을 다시 한번 보고 적용할 수 있는 좋은 시간이었다.

욕심이 생긴 만큼 만족스러운 결과는 아니지만, 앞으로 무언가를 할 때 피가 되고 살이 될 것이라고 확신한다.
